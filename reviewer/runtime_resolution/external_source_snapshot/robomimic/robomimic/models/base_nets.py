...
# ===== M445G_R1D_R5 ResNet FiLM compatibility aliases start =====
# Compatibility aliases created by M445G_R1D_R5.
#
# RoboCasa Diffusion Policy switches backbone_class to ResNet*ConvFiLM when
# lang_emb exists. The current robomimic package does not expose these FiLM
# backbone names. These aliases unblock workspace instantiate dryrun only.
# They do not claim full official FiLM conditioning semantics.

try:
    ResNet18ConvFiLM
except NameError:
    try:
        class ResNet18ConvFiLM(ResNet18Conv):
            pass
    except NameError:
        pass
...
try:
    ...
    try:
        class ResNet34ConvFiLM(ResNet34Conv):
            pass
    except NameError:
        pass
...
try:
    ...
    try:
        class ResNet50ConvFiLM(ResNet50Conv):
            pass
    except NameError:
        pass
# ===== M445G_R1D_R5 ResNet FiLM compatibility aliases end =====
